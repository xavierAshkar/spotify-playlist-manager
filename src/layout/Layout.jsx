...
export default function Layout({
  ...
  >
    ...
    <div className="flex-1 min-h-0 grid overflow-hidden grid-cols-[var(--left-w)_minmax(0,1fr)_var(--right-w)]">
      <aside className="min-h-0 overflow-y-auto custom-scrollbar stable-gutter border-r border-lightBg">{left}</aside>
      <main  className="min-w-0 min-h-0 overflow-y-auto custom-scrollbar stable-gutter">{main}</main>
      <aside className="min-h-0 overflow-y-auto custom-scrollbar stable-gutter border-l border-lightBg">{right}</aside>
    </div>
